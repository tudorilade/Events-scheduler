...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('token_email', models.CharField(blank=True, max_length=256, null=True)),
                ('token_reset_password', models.CharField(blank=True, max_length=256, null=True)),
                ('expiration_date_reset_password_token', models.DateTimeField(blank=True, null=True)),
